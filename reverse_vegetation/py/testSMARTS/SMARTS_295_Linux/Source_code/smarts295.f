...
c 
 ...
 126  FORMAT(/,33('*',2x),//,'** SPECTRUM:',/,'   Total (0-100 \B5m) ',
...
c
 ...
 188  FORMAT(///,'*** ILLUMINANCES (klux) obtained with the Vlambda'
     ...
     8 ,'FLUX DENSITY (\B5mol m-2 s-1) for 400-700 nm:',/,' BEAM NORMAL'
...
c
 ...
 195  Format('** WARNING #13 ',9('*'),/,'\\ Ground reflectance data ',
     ...
     3  f6.4,' \B5m,',/,'\\ whereas the wavelength limits for this run ',
     4 'are ',f6.4,' and ',f6.4,' \B5m.',/,'\\ Consequently, reflect',
     5 'ance is fixed at ',F5.3,' below ',f6.4,' \B5m and at ',F5.3,
     6 ' above ',f6.4,' \B5m.',//)
      Return
      End
c
